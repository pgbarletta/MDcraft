...
import mdcraft.solver.potential
...
from mdcraft.solver.potential  import MLIP4 as Potential
...
a = 4.05
supercell = (4,4,4)
ase_atoms = create_fcc("Al", a, *supercell)
...
print("MASSES: ", atoms.data["m"])

##############################################################
potential = Potential("./Al.json", domain)
