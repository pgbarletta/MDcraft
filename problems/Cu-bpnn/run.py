...
from mdcraft.solver            import Ternary as Solver
from mdcraft.solver.potential  import MaiseBPNNPotential as Potential
...
##############################################################
potential = Potential("./nn_Cu_d3_v0", domain)
...
atoms.data["rns"] = atoms.data["rcut"]#*kBuf already done in maise
