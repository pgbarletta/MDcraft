...
tend	 = 1000e-3            # final time (ps)
dt	     = 1e-3           # timestep (ps)
NCsave   = 100 			  # save atoms
...
positions = [
	np.array([55.4513900000,    54.3269700000,    53.5664500000]),
 	np.array([54.0585900000,    54.9453900000,    54.5274400000]),   
 	np.array([55.6173700000,    55.7721300000,    54.6488800000]),   
 	np.array([55.4695700000,    54.1304600000,    55.3741500000]),   
 	np.array([55.1628400000,    54.7731400000,    54.5439000000])   
]

ase_atoms = AtomsASE("H4C1",
...
##############################################################
potential = Potential("./graph.pb", domain)
...
atoms.data["rns"] = atoms.data["rcut"]*kBuf
